...
/**
 * Generated class for the OrderScanReturnPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-order-scan-return',
  templateUrl: 'order-scan-return.html',
})
export class OrderScanReturnPage {
